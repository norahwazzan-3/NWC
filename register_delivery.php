...
<head>
  ...
  <title>Register Unregistered Meter</title>
...
<body class="bg-gradient-to-br from-blue-100 to-blue-200 min-h-screen flex items-center justify-center p-6">
  ...
  <div class="bg-white bg-opacity-90 p-10 rounded-3xl shadow-2xl w-full max-w-4xl">
    <div class="text-center mb-8">
      <h2 class="text-4xl font-extrabold text-blue-800 mb-2">Register Unregistered Water Meter</h2>
      <p class="text-gray-600 text-lg">Please provide the following details to register your meter.</p>
    </div>

    <form action="submit_register_delivery.php" method="POST" enctype="multipart/form-data" class="space-y-6">
      <input type="hidden" name="service_type" value="register_delivery">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          <input type="text" name="existing_address" required class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-400">
        </div>

        <!-- Meter Number -->
        <div>
          <label class="block mb-2 text-gray-700 font-medium">Meter Number</label>
          <input type="text" name="meter_number" required class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-400">
        </div>

        <!-- Contact Number -->
        <div>
          <label class="block mb-2 text-gray-700 font-medium">Contact Number</label>
      ...
      <!-- Ownership -->
      <div>
        <label class="block mb-2 text-gray-700 font-medium">Do you own the property?</label>
      ...
      <div id="auth-fields" class="hidden">
        ...
        <label class="block mb-2 text-gray-700 font-medium">Deed Number</label>
        <input type="text" name="deed_number_auth" class="w-full mb-4 px-4 py-2 border rounded-lg">
      </div>

      <!-- Upload Documents -->
      <div>
        <label class="block mb-2 text-gray-700 font-medium">Upload Documents</label>
